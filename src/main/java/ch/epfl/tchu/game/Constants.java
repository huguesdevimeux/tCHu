...
public final class Constants {
    ...
    /**
     * Nombre de points obtenus pour la construction de routes de longueur 1 à 6. (L'élément à
     * l'index i correspond à une longueur de route i. Une valeur invalide est placée à l'index 0,
     * car les routes de longueur 0 n'existent pas).
     */
    ...
    private static SortedBag<Card> computeAllCards() {
        ...
        for (Card card : Card.CARS) cardsBuilder.add(CAR_CARDS_COUNT, card);
