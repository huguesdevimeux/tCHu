...
public class TranslationAnimation implements AnimationAttacher {
    ...
    /**
     * Construct a TranslationOnHover animation, given the animated node and the necessary
     * parameters.
     *
    ...
    /**
     * Given a target, applies an animation translation to the target while taking care of not going
     * further the target. Stop translateTransition if playing.
     *
