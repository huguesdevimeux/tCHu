...
public final class Serdes {
    ...
    public static final Serde<String> stringSerde =
            Serde.of(
                    obj -> Base64.getEncoder().encodeToString(obj.getBytes(Constants.Serdes.ENCODING)),
                    str ->
                            new String(
                                    Base64.getDecoder().decode(str.getBytes()),
                                    Constants.Serdes.ENCODING));
    /** Serde for PlayerId */
    ...
    public static final Serde<PublicCardState> publicCardStateSerde =
            Serde.of(
                    ...
                    (str) -> {
                        ...
                        String[] elements = str.split(Pattern.quote(Constants.Serdes.SEPARATOR_2), -1);
    ...
    public static final Serde<PublicGameState> publicGameStateSerde =
            Serde.of( // same principle, join each serialized element with ":"
                    ...
                    (str) -> {
                        ...
                        String[] elements = str.split(Pattern.quote(Constants.Serdes.SEPARATOR_3), -1);
